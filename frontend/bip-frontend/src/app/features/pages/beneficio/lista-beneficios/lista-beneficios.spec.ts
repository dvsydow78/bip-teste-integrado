...
describe('ListaBeneficiosComponent', () => {
  ...
  describe('carregarBeneficios() — erro de serviço indisponível (status 0)', () => {
  ...
  describe('carregarBeneficios() — erro de serviço indisponível (status 503)', () => {
  ...
  describe('carregarBeneficios() — erro genérico', () => {
    ...
    it('deve limpar erro ao tentar novamente com sucesso', async () => {
  ...
  describe('Estado da lista', () => {
    ...
    it('deve ter 3 itens após carregar mock', () => {
